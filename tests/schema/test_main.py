...
def test_int_main_version(tb):
    ms_version = tb.getkeyword('MS_VERSION')
    assert ms_version == 2.0


def test_int_main_schema_time(tb):
...
def test_int_main_schema_antenna1(tb):
    col = get_checker(tb, 'ANTENNA1')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_antenna2(tb):
    col = get_checker(tb, 'ANTENNA2')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_feed1(tb):
    col = get_checker(tb, 'FEED1')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_feed2(tb):
    col = get_checker(tb, 'FEED2')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_data_desc_id(tb):
    col = get_checker(tb, 'DATA_DESC_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_processor_id(tb):
    col = get_checker(tb, 'PROCESSOR_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_field_id(tb):
    col = get_checker(tb, 'FIELD_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_interval(tb):
    col = get_checker(tb, 'INTERVAL')
    assert col.is_scalar()
    assert col.get_type() == 'double'


def test_int_main_schema_exposure(tb):
    col = get_checker(tb, 'EXPOSURE')
    assert col.is_scalar()
    assert col.get_type() == 'double'


def test_int_main_schema_time_centroid(tb):
...
def test_int_main_schema_scan_number(tb):
    col = get_checker(tb, 'SCAN_NUMBER')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_array_id(tb):
    col = get_checker(tb, 'ARRAY_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_observation_id(tb):
    col = get_checker(tb, 'OBSERVATION_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_state_id(tb):
    col = get_checker(tb, 'STATE_ID')
    assert col.is_scalar()
    assert col.get_type() == 'int'


def test_int_main_schema_uvw(tb):
...
def test_int_main_schema_float_data(tb):
...
def test_int_main_schema_sigma(tb):
...
def test_int_main_schema_weight(tb):
...
def test_int_main_schema_flag(tb):
...
def test_int_main_schema_flag_category(tb):
...
def test_int_main_schema_flag_row(tb):
